...
export const RevenueChartSkeleton = () =>
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
        ...
        <div className="rounded-xl bg-gray-100 p-4">
            <div className="mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-white p-4 sm:grid-cols-13 md:gap-4 h-[410px]" />
    ...
    <div className={`${shimmer} relative flex w-full flex-col overflow-hidden md:col-span-4`}>
        ...
        <div className="flex grow flex-col justify-between rounded-xl bg-gray-100 p-4">
            <div className="bg-white px-6">
                ...
                <div className="flex items-center pb-2 pt-6">
                    <div className="h-5 w-5 rounded-full bg-gray-200" />
                    <div className="ml-2 h-4 w20 rounded-md bg-gray-200" />
                </div>
            </div>
        </div>
    </div>
